<div wire:poll class="h-screen flex" data-cy="lobby-list">
    <div class="m-auto min-w-3/6 h-fit">
        <div class="bg-(--white) rounded-t-[24px] border-t-8 border-x-8 border-(--blue-light) p-3 flex justify-between ">
            ...
            <div class="flex items-center">
                <a href="{{route("createLobby")}}" id="createLobby" class="bg-(--blue-light) p-3 rounded-xl text-(--text-color-light) " data-cy="create-lobby-button">Lobby aanmaken</a>
            </div>
        </div>
